...
import 'package:flow/src/features/task_instances/presentation/task_instance_list_card/task_instance_list_card.dart';
import 'package:flow/src/localization/string_hardcoded.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class CheckList extends ConsumerWidget {
  const CheckList({super.key, required this.date});
      ...
      data: (dateTaskInstances) {
        ...
        return Padding(
          ...
          child: ListView.builder(
            ...
            shrinkWrap: true,
            itemCount: dateTaskInstances.taskInstancesList.length,
            itemBuilder: (context, index) {
              return TaskInstanceListCard(
                taskInstance: dateTaskInstances.taskInstancesList[index],
              );
            },
          ),
        );
