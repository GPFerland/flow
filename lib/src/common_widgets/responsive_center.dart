...
/// If available width is larger than the maximum width,
/// the child will be centered.
/// If available width is smaller than the maximum width,
/// the child use all the available width.
